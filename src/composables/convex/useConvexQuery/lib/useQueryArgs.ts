import type { OptionalRestArgsAndOptions } from "../../optional.types";
import type { FunctionReference } from "convex/server";
import type { UseConvexQueryOptions } from "../../queryReturn.types";
 ...
 */
export function useQueryArgs<Query extends FunctionReference<"query">>(
